...
<head>
    ...
    <title>Institut Polyvalent Bilingue Les Pintades - Modifier Classe</title>
        ...
        <div class="content-area">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('classes.show', $classe) }}" class="btn btn-warning">
                ...
                <form action="{{ route('classes.update', $classe) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" id="code" value="{{ old('code', $classe->code) }}"
                                       placeholder="Ex: FR6ESCI"
                                       class="form-control @error('code') is-invalid @enderror" maxlength="10">
                                @error('code')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                                <div class="help-text">
                                    Code actuel: <strong>{{ $classe->code }}</strong>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="capacite_max" id="capacite_max" 
                                       value="{{ old('capacite_max', $classe->capacite_max) }}" min="1" max="50"
                                ...
                                <select name="salle_principale_id" id="salle_principale_id" class="form-select @error('salle_principale_id') is-invalid @enderror">
                                    ...
                                    @foreach($salles as $salle)
                                        <option value="{{ $salle->id }}" 
                                                ...
                                                {{ (old('salle_principale_id', $classe->salle_principale_id) == $salle->id) ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" name="actif" id="actif" value="1" 
                                   {{ old('actif', $classe->actif) ? 'checked' : '' }} class="form-check-input">
                    ...
                    <div class="code-preview">
                        ...
                        <div id="code-preview" class="code-display">
                            <span style="color: var(--primary-color); font-weight: 600;">{{ $classe->code }}</span>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateCodePreview() {
                ...
                if (sectionSelect.value && niveauSelect.value && filiereSelect.value) {
                    ...
                    codePreview.innerHTML = '<span style="color: #6b7280;">Code actuel: {{ $classe->code }}</span>';
                }
            }
